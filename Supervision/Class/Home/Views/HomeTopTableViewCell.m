...
- (void)setDataSource:(NSMutableArray *)dataSource{
    ...
    if (_dataSource && _dataSource.count>0 ) {
        ...
        if (_titles.count>2) {
            scrollLabelView1 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56, _noticeview.width -10, 15)];
            scrollLabelView2 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20, _noticeview.width -10, 15)];
            scrollLabelView3 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20 + 20, _noticeview.width -10, 15)];
            ...
            scrollLabelView1 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20, _noticeview.width -10, 15)];
            [self initUI:scrollLabelView1 arr:_titles titleColor:RGBA(0, 0, 0, 1)];
        }
    }
}
