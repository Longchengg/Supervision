...
- (void)setDataSource:(NSMutableArray *)dataSource{
    ...
    if (_dataSource && _dataSource.count>0 ) {
        ...
        if (_titles.count>2) {
            scrollLabelView1 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56, SCREEN_WIDTH - 50, 15)];
            scrollLabelView2 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20, SCREEN_WIDTH - 50, 15)];
            scrollLabelView3 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20 + 20, SCREEN_WIDTH - 50, 15)];
            ...
            scrollLabelView1 = [[WCScrollLabelView alloc] initWithFrame:CGRectMake(5, 56 + 20, SCREEN_WIDTH - 50, 15)];
            [self initUI:scrollLabelView1 arr:_titles titleColor:RGBA(0, 0, 0, 1)];
        }
    }
}
