...
- (void)awakeFromNib{
    ...
    int nowYear = [self.currentYear intValue] + 120;
    ...
    [self.ymPikerView selectRow:(self.yearsArr.count-1 -120) inComponent:0 animated:YES];
...
//    }
    if (self.delegate) {
        [self.delegate selectedDate:self.selectYear MonthStr:self.selectMonth];
       }
}
