//
//  toJianNiuzixunViewController.m
//  Supervision
//
...
@interface toJianNiuzixunViewController () <SYProgressWebViewDelegate>
...
@implementation toJianNiuzixunViewController
...
{
    if (_xinxiUrl) {
        _webViewStr = _xinxiUrl;
    }else{
        _webViewStr = [NSString stringWithFormat:@"%@/notice/policy/article/%@", HttpRequestURLQ,_webId];
    }
    [self webViewUIPush];
}
