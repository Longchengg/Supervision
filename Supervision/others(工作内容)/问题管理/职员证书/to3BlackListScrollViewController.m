...
-(void)loadData:(BOOL)loadMore{
    ...
    WEAK_SELF;
    [HttpRequestTool personCert:_processStatus certCategoryId:_certCategoryId page:[NSString stringWithFormat:@"%ld",(long)_page] size:@"10" SuccessBlock:^(id responObject) {
        //是否是加载更多
