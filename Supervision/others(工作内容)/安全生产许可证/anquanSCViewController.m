...
@interface anquanSCViewController ()<
UITableViewDelegate,
...
@implementation anquanSCViewController
...
-(void)loadData:(BOOL)loadMore{
    ...
    WEAK_SELF;
    [HttpRequestTool safety_listSuccessBlock:^(id responObject) {
        //是否是加载更多
...
- ( UITableViewCell *)tableView:( UITableView *)tableView cellForRowAtIndexPath:( NSIndexPath *)indexPath
{
    ...
    [cell setlab1:@"安全生产许可证" lab2:@"" lab3:@"详情 >" lab4:_qualificationsModel.scopeDesc btn1:_qualificationsModel.alertStatus[@"status"] Sbtn1:_qualificationsModel.alertStatus[@"desc"] btn2:_qualificationsModel.backStatus];
    return cell;
}
